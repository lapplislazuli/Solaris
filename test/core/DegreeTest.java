...
public class DegreeTest {
	@Test
	void BasicDegree() {
		Star anker1= new Star("anker1", null, new AbsolutePoint(0, 0), 0);

		Star anker2= new Star("anker2", null, new AbsolutePoint(100, 0),0);
		...
		Star anker3= new Star("anker3", null, new AbsolutePoint(100, -50),0);
		//Expected: 90°
