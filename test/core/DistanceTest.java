...
class DistanceTest {
	...
	void positiveDistance() {
		Star anker= new Star("anker", null, new Point( 0, 0), new Circle(new Point(0,0), 0));
	...
	void negativeDistance() {
		Star anker= new Star("anker", null, new Point(150, 0), new Circle(new Point(150,0), 0));
		Planet a = new Planet("a", anker, null, 0, 0, 0);
		Planet b = new Planet("b", anker, null, 0, -50, 0);
		Planet c = new Planet("c", anker, null, 0, -100, 0);
	...
	@Test
	void nullDistance() {
		Star anker1= new Star("anker", null, new Point( 0, 0), new Circle(new Point(0,0), 0));
		Star anker2= new Star("anker", null, new Point( 0, 0), new Circle(new Point(0,0), 0));
